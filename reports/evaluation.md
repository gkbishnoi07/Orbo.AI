...
- **Model inference latency:** p95 13ms across all models, inside the 100ms budget. This is `Recommender.recommend()` only — it excludes explanation generation and all Streamlit rendering, so it is not end-to-end user latency.
...
|----------------|--------------|-----------|---------|--------|----------|----------------|----------------|-------------------|---------|-----------|---------|
| random         | 0.0001       | 0.0010    | 0.0004  | 0.0002 | 0.6877   | 6.0            | 7.6            | 0.0000            | 1,000   | 0.9037    | 8.2332  |
| popularity     | 0.0060       | 0.0600    | 0.0307  | 0.0220 | 0.0021   | 5.7            | 6.9            | 0.0000            | 1,000   | 0.8744    | -2.5979 |
| cf-only        | 0.0466       | 0.4660    | 0.4135  | 0.3974 | 0.1552   | 5.8            | 7.2            | 0.0000            | 1,000   | 0.7482    | 0.0292  |
| content-minilm | 0.0147       | 0.1470    | 0.1166  | 0.1072 | 0.1103   | 8.2            | 10.4           | 0.0000            | 1,000   | 0.6462    | 3.8933  |
| content-tfidf  | 0.0283       | 0.2830    | 0.2404  | 0.2269 | 0.1659   | 7.8            | 9.8            | 0.0000            | 1,000   | 0.5212    | 3.7614  |
| hybrid-minilm  | 0.0460       | 0.4600    | 0.4110  | 0.3959 | 0.1297   | 10.4           | 12.8           | 0.0000            | 1,000   | 0.7558    | -0.3908 |
| hybrid-tfidf   | 0.0458       | 0.4580    | 0.4112  | 0.3967 | 0.1419   | 9.9            | 12.2           | 0.0000            | 1,000   | 0.7396    | -0.1209 |
...
| model          | precision@10 | recall@10 | ndcg@10 | map@10 | coverage | latency_p50_ms | latency_p95_ms | empty_result_rate | n_cases | diversity | novelty |
|----------------|--------------|-----------|---------|--------|----------|----------------|----------------|-------------------|---------|-----------|---------|
| random         | 0.0000       | 0.0000    | 0.0000  | 0.0000 | 0.6858   | 5.8            | 8.1            | 0.0000            | 1,000   | 0.9045    | 8.2190  |
| popularity     | 0.0110       | 0.1100    | 0.0693  | 0.0570 | 0.0014   | 5.5            | 7.8            | 0.0000            | 1,000   | 0.8757    | -2.6111 |
| cf-only        | 0.0103       | 0.1030    | 0.0693  | 0.0587 | 0.0024   | 5.5            | 7.4            | 0.0000            | 1,000   | 0.8377    | -2.5223 |
| content-minilm | 0.0006       | 0.0060    | 0.0024  | 0.0013 | 0.0038   | 8.0            | 10.1           | 0.0000            | 1,000   | 0.6098    | 5.0303  |
| content-tfidf  | 0.0003       | 0.0030    | 0.0019  | 0.0016 | 0.0038   | 7.7            | 9.8            | 0.0000            | 1,000   | 0.4788    | 4.9320  |
| hybrid-minilm  | 0.0097       | 0.0970    | 0.0665  | 0.0570 | 0.0021   | 10.2           | 12.6           | 0.0000            | 1,000   | 0.8141    | -2.5496 |
| hybrid-tfidf   | 0.0096       | 0.0960    | 0.0653  | 0.0557 | 0.0025   | 9.8            | 12.5           | 0.0000            | 1,000   | 0.8346    | -2.5160 |
...
| model            | precision@10 | recall@10 | ndcg@10 | map@10 | coverage | latency_p50_ms | latency_p95_ms | empty_result_rate | n_cases | diversity | novelty |
|------------------|--------------|-----------|---------|--------|----------|----------------|----------------|-------------------|---------|-----------|---------|
| popularity-LEAKY | 0.0062       | 0.0620    | 0.0313  | 0.0222 | 0.0021   | 5.8            | 7.4            | 0.0000            | 1,000   | 0.8756    | -2.5979 |
| cf-only-LEAKY    | 0.0495       | 0.4950    | 0.4290  | 0.4088 | 0.1551   | 6.1            | 7.7            | 0.0000            | 1,000   | 0.7481    | 0.0278  |
